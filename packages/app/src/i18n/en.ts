export const dict = {
  ...
  "command.prompt.voice.toggle": "Start or stop dictation",
  ...
  "prompt.action.voice.start": "Record voice",
  "prompt.action.voice.requesting": "Requesting microphone…",
  "prompt.action.voice.cancel": "Cancel recording",
  "prompt.action.voice.stop": "Stop recording",
  "prompt.action.voice.transcribing": "Transcribing…",
  "prompt.voiceMode.title": "Voice Mode",
  "prompt.voiceMode.action.open": "Open Voice Mode",
  "prompt.voiceMode.action.mute": "Mute microphone",
  "prompt.voiceMode.action.unmute": "Unmute microphone",
  "prompt.voiceMode.action.exit": "Exit Voice Mode",
  "prompt.voiceMode.action.close": "Close",
  "prompt.voiceMode.status.closed": "Closed",
  "prompt.voiceMode.status.connecting": "Connecting…",
  "prompt.voiceMode.status.listening": "Listening",
  "prompt.voiceMode.status.thinking": "Thinking",
  "prompt.voiceMode.status.speaking": "Speaking",
  "prompt.voiceMode.status.muted": "Microphone muted",
  "prompt.voiceMode.status.reconnecting": "Reconnecting…",
  "prompt.voiceMode.status.error": "Connection error",
  "prompt.voiceMode.capability.audio": "Voice replies enabled",
  "prompt.voiceMode.capability.textOnly": "Text-only replies: this server reports no TTS.",
  "prompt.voiceMode.capability.awaitingAudio": "Text and final transcripts only until the server confirms TTS.",
  "prompt.toast.voiceFailed.title": "Voice input failed",
  "prompt.toast.voiceTooShort.title": "Recording too short",
  "prompt.toast.voiceTooShort.description": "Nothing was sent — hold the button while you speak.",
  "prompt.toast.voiceEmpty.title": "No speech recognized",
  "prompt.toast.voiceEmpty.description": "Nothing was inserted — try again, closer to the microphone.",
