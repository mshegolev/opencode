export const dict = {
  ...
  "prompt.action.voice.start": "Записать голос",
  "prompt.action.voice.requesting": "Запрашиваю доступ к микрофону…",
  "prompt.action.voice.cancel": "Отменить запись",
  "prompt.action.voice.stop": "Остановить запись",
  "prompt.action.voice.transcribing": "Распознаю…",
  "prompt.voiceMode.title": "Голосовой режим",
  "prompt.voiceMode.action.open": "Открыть голосовой режим",
  "prompt.voiceMode.action.mute": "Выключить микрофон",
  "prompt.voiceMode.action.unmute": "Включить микрофон",
  "prompt.voiceMode.action.exit": "Выйти из голосового режима",
  "prompt.voiceMode.action.close": "Закрыть",
  "prompt.voiceMode.status.closed": "Закрыт",
  "prompt.voiceMode.status.connecting": "Подключение…",
  "prompt.voiceMode.status.listening": "Слушаю",
  "prompt.voiceMode.status.thinking": "Думаю",
  "prompt.voiceMode.status.speaking": "Отвечаю голосом",
  "prompt.voiceMode.status.muted": "Микрофон выключен",
  "prompt.voiceMode.status.reconnecting": "Переподключение…",
  "prompt.voiceMode.status.error": "Ошибка соединения",
  "prompt.voiceMode.capability.audio": "Голосовые ответы доступны",
  "prompt.voiceMode.capability.textOnly": "Только текст: сервер сообщил, что TTS недоступен.",
  "prompt.voiceMode.capability.awaitingAudio": "Только текст и финальная расшифровка, пока сервер не подтвердит TTS.",
  "prompt.toast.voiceFailed.title": "Голосовой ввод не сработал",
  "prompt.toast.voiceTooShort.title": "Запись слишком короткая",
  "prompt.toast.voiceTooShort.description": "Ничего не отправлено — говорите, пока идёт запись.",
  "prompt.toast.voiceEmpty.title": "Речь не распознана",
  "prompt.toast.voiceEmpty.description": "Ничего не вставлено — попробуйте ещё раз, ближе к микрофону.",
